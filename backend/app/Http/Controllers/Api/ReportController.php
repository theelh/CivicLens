...
use App\Models\Api\ReportAudio;
use App\Models\Api\ReportImage;
...
if (!empty($validated['category_id'])) {
    $categoryId = \App\Models\Api\Category::where('name', $validated['category_id'])
        ->value('id');
}
...
{
    return \App\Models\Api\Category::whereRaw('LOWER(name) = ?', [strtolower($category)])
        ->value('id');
}
