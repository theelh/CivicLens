...
export default function Show() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'My Reports',   href: '/admin/reports/all' },
        { title: report.title ?? `Report ${report.id}`, href: `/admin/reports/${report.id}` },
    ];
    ...
    const handleAnalyze = () => {
        setAnalyzing(true);
        router.post(`/admin/reports/${report.id}/analy`, {}, {
            preserveScroll: true,
    ...
    const handleMarkClosed = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.post(`/admin/reports/${report.id}/closed`, {}, { preserveScroll: true });
            }
        });
    };
    ...
    const handleDelete = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(`/admin/reports/${report.id}/destroy`, {
                    onSuccess: () => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Deleted!',
