...
export default function Notifications() {
    ...
    const markRead = (id: number) => {
        ...
        router.post(`/staff/notifications/${id}/read`, {}, { preserveScroll: true });
    };

    const markUnread = (id: number) => {
        setItems(prev => prev.map(n => n.id === id ? { ...n, is_read: false } : n));
        router.post(`/staff/notifications/${id}/unread`, {}, { preserveScroll: true });
    };

    const markAllRead = () => {
        setItems(prev => prev.map(n => ({ ...n, is_read: true })));
        router.post('/staff/notifications/read-all', {}, { preserveScroll: true });
    };
    ...
    const deleteOne = (id: number) => {
        ...
        router.delete(`/staff/notifications/${id}`, { preserveScroll: true });
    };
    ...
    const deleteSelected = () => {
        ...
        setSelected(new Set());
        ids.forEach(id => router.delete(`/staff/notifications/${id}`, { preserveScroll: true }));
    };

    const deleteAllRead = () => {
        setItems(prev => prev.filter(n => !n.is_read));
        router.delete('/staff/notifications/read', { preserveScroll: true });
    };
