            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-4 md:p-6">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#2369A4] to-cyan-500 px-6 py-5 text-white shadow-lg">
                    ...
                    <div className="relative">
                        ...
                        <a href='/staff/reports/submit' className="mt-4 inline-flex items-center gap-2 rounded-xl bg-white/20 px-4 py-2 text-sm font-semibold backdrop-blur-sm transition hover:bg-white/30">
                            <span>📸</span> Submit a New Report
                        </a>
                        <a href="/staff/notifications" className="mt-4 mx-3 relative inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-[#171717] text-sm font-semibold backdrop-blur-sm transition hover:bg-white/30">
                            🔔 Notifications
