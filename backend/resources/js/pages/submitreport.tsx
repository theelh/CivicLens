...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Submit Report', href: '/reports/submit' },
];
...
export default function SubmitReport() {
    ...
    const handleImageChange = useCallback(async (file: File) => {
        ...
        try {
            ...
            const res = await axios.post<AiAnalysis>('/reports/analyze-image', fd);
            const ai  = res.data;
            setAiAnalysis(ai);
        ...
        try {
            ...
            mr.onstop = async () => {
                ...
                try {
                    ...
                    fd.append('_token', csrfToken());
                    const res = await axios.post<{ text: string }>('/reports/transcribe', fd);
                    if (res.data.text) {
                        setData('description', d =>
